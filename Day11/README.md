...
The tough part is parsing the input. In my case, I have used a dictionary for each monkey.
...
The process itself is quite simple, it is fully explained in the problem.
...
As time goes by, items grow uncontrollably. One way to reduce them is working mod the product of all divisibility tests. 
