...
This is an easy problem, you only have to iterate over the instructions and be careful with the cycles.
...
It is only necessary to manage the printing every cycle and draw a new line every 40 cycles.
...
And thus the answer is: `FZBPBFZF`.
